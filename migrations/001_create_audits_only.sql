...
-- 允许所有人读取
CREATE POLICY "Allow public read audits"
ON public.audits FOR SELECT
USING (true);

-- 允许service_role完全访问
CREATE POLICY "Allow service_role all audits"
ON public.audits FOR ALL TO service_role
USING (true) WITH CHECK (true);

-- 完成
SELECT 'Audits table created successfully!' AS result;
